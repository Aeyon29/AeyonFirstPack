...
export class ForRentSign implements ISystem {
  META_ID = 92 // Change to your MetaZone meta number identifier
  ...
  constructor(api, host_data) {
    ...
    this.modelEntity.addComponent(new GLTFShape('metas/forrentsign/models/forrent.glb'))
